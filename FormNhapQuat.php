...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO nhapquat (ten_mat_hang, so_luong, don_gia, don_vi, ngay_nhap, nguoi_nhap, thanh_tien, tong_tien) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
  <meta charset="UTF-8">
  <title>Thêm Nhập Quất</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-4">
  <h2>Thêm dữ liệu Nhập Quất</h2>
