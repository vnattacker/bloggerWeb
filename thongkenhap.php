...
// Lấy dữ liệu nhập mía và số lượng bán tương ứng
$sqlThongKe = "SELECT
    nm.id AS nhap_id,
...
FROM nhapmia nm
LEFT JOIN bannuocmia bnm ON DATE(nm.ngay_nhap) <= DATE(bnm.ngay_ban)
GROUP BY nm.id, nm.ten_mat_hang, nm.ngay_nhap
