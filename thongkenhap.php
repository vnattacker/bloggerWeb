...
$color = $tongTienLai <= 0 ?  "bg-danger" :  "bg-teal"; 
?>
    <div class="container mt-5">
        <h2 class="mb-4 text-center">Thống kê Chung</h2>
        <div class="row mb-4">
            <div class="col-md-4">
        ...
        <h2 class="mb-4 text-center">Thống kê Số Lượng Bán Theo Đợt Nhập Mía</h2>
        ...
        <div class="row mb-4">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">Biểu đồ Số lượng ly nước mía bán được theo đợt nhập mía</h5>
        ...
        <h2 class="mb-4 text-center">Thống kê Lãi Theo Thời Gian</h2>
        <div class="row mb-4">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">Biểu đồ Doanh thu và Chi phí theo thời gian</h5>
        ...
        <h2 class="mb-4 text-center">Thống kê Nhập và Chi Tiêu</h2>
        <div class="row mb-4">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">Biểu đồ Tổng tiền nhập và chi tiêu theo thời gian</h5>
                ...
                datasets: [
                    {
                        label: 'Doanh thu',
                        data: [
                            <?php echo number_format($doanhThuHomNay ?? 0); ?>,
                            <?php echo number_format($doanhThuHomQua ?? 0); ?>,
                            <?php echo number_format($doanhThuThangNay ?? 0); ?>,
                            <?php echo number_format($doanhThuThangTruoc ?? 0); ?>
                        ],
                    ...
                    },
                    {
                        label: 'Chi phí',
                        data: [
                            <?php echo number_format(($chiPhiNhapHomNay ?? 0) + ($chiPhiKhacHomNay ?? 0) + ($chiPhiDienNuocHomNay ?? 0)); ?>,
                            <?php echo number_format(($chiPhiNhapHomQua ?? 0) + ($chiPhiKhacHomQua ?? 0) + ($chiPhiDienNuocHomQua ?? 0)); ?>,
                            <?php echo number_format(($chiPhiNhapThangNay ?? 0) + ($chiPhiKhacThangNay ?? 0) + ($chiPhiDienNuocThangNay ?? 0)); ?>,
                            <?php echo number_format(($chiPhiNhapThangTruoc ?? 0) + ($chiPhiKhacThangTruoc ?? 0) + ($chiPhiDienNuocThangTruoc ?? 0)); ?>
                        ],
