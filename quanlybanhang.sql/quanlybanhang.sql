...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 21, 2025 lúc 03:38 PM
...
(1, 'Mía trắng - cao + chất', 1, 0, 'Bó Nhỏ', '2025-04-15', 'A Dũng (Đã trả)', 0),
...
CREATE TABLE `tiendiennuoc` (
  ...
  `so_cong_to_thang_truoc` int DEFAULT NULL,
  `so_cong_to_thang_sau` int DEFAULT NULL,
